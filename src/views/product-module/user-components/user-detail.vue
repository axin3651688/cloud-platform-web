<template>
  <div class="user-detail" style="display: flex;flex-direction: row;">
    <div style="width: 407px;background-color: #fff">
      <div style="display: flex;flex-direction: column;border-bottom: 1px solid #EAEDF3;">
        <div style="display: flex;flex-direction: column;justify-content: center;align-items: center">
          <img v-if="info.avatarUrl" :src="info.avatarUrl" style="width: 407px;height: 290px;"/>
        </div>
        <div style="padding: 20px 0 24px 32px;">
          <h2>租户名称</h2>
          <a-select
            style="width: 120px;"
            placeholder="租户的状态"
      ...
      <div style="margin-top: 20px;">
        <div style="margin-left: 49px"><span style="color: #9EA0A5">绑定账号</span></div>
        <account :name="'云智囊'" :number="'120'"></account>
        <account :name="'QQ'" :number="'110'"></account>
        <account :name="'新浪微博'" :number="'119'"></account>
        <account :name="'微信'" :number="'12345'"></account>
        <account :name="'钉钉'" :number="'12306'"></account>
        <account :name="'淘宝'" :number="'666'"></account>
      </div>
    </div>
    <div style="margin-left: 14px;min-width: 400px;background-color: #fff;padding: 32px;">
      <a-form
        :form="form"
        class="user-table">
        <a-row
