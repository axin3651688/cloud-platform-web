<template>
  <div>
      ...
      <div class="license-header">
        ...
        >
          ...
          <a-table-column
            ...
            key="action">
            <template slot-scope="text, record">
              <span @click="btnClick(record)" title="编辑">
                <a-icon type="edit" />
              </span>
            </template>
          </a-table-column>
          <template slot="expandedRowRender">
            ...
            >
              <div style="display: flex;flex-direction: column;flex-grow: 1;margin-left: 30px;" v-if="info">
                <div class="middle-a">
    ...
    <!--编辑牌照-->
    <a-modal v-model="editState" title="牌照编辑">
      <a-form :form="form3">
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="牌照名称:">
